...
class Auth:
    ...
    __client_id = '3534cc8fb4484f8e9be4e336521a9185'
    __client_secret = '69dcd72cfc0845c9a54e137f653eec8e'
    __server = 'localhost'
    __port = 8080
    ...
    __scope = ['user-top-read','user-read-email','playlist-read-private']
